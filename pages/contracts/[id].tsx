...
import { GET_CONTRACT_DETAIL } from '../../queries';
...
export default function ContractDetail() {
  ...
  useEffect(() => {
    if (status == 'authenticated' && id != null) fetchData();
  }, [status, id]);
                      ...
                      >
                        <TableBody>
                          ...
                          >
                            ...
                            <TableCell component="th" scope="row">
                              ...
                              <FormControlLabel
                                ...
                                control={
                                  <Checkbox
                                    checked={item?.shipmentInformation?.partialShipment ?? false}
                                  />
                                }
                                label={undefined}
                              />
                          ...
                          >
                            ...
                            <TableCell component="th" scope="row">
                              ...
                              <FormControlLabel
                                ...
                                control={
                                  <Checkbox
                                    checked={item?.shipmentInformation?.transhipment ?? false}
                                  />
                                }
                                label={undefined}
                              />
                          ...
                          >
                            ...
                            <TableCell component="th" scope="row">
                              {new Date(
                                parseInt(item?.shipmentInformation?.latestShipmentDate),
                              ).toDateString()}
                            </TableCell>
                          </TableRow>
                        </TableBody>
