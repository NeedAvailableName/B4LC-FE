  ...
  return (
    <div className="font-serif">
      ...
      <Box className="rounded-lg p-4 border-4 border-indigo-500/100 bg-white">
        <div onClick={addFormItem} className="flex pb-2 items-center cursor-pointer">
        ...
        {formItems.map((item, index) => (
          <>
            <div key={index} className="pr-4 pl-4 border border-gray-300 rounded flex items-center justify-between bg-gray-100">
